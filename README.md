...
O sistema foi desenvolvido para ilustrar o fluxo de autorização externa. Ao clicar no ícone do GitHub, o usuário é redirecionado para a plataforma oficial para autorizar o acesso, retornando para a aplicação com uma confirmação de sucesso.
...
* [x] Integração com a API de autenticação do GitHub.
* [x] Feedback visual de login bem-sucedido.
* [x] Função de Logout para encerramento de sessão.
